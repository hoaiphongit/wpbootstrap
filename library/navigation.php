...
/**
 * Adapted for Bootstrap from http://thewebtaylor.com/articles/wordpress-creating-breadcrumbs-without-a-plugin
 *
...
if ( ! function_exists( 'wpbootstrap_breadcrumb' ) ) {
	function wpbootstrap_breadcrumb( $showhome = true, $separatorclass = false ) {
		...
		if ( ! is_front_page() ) {
			...
			if ( is_single() && ! is_attachment() ) {
				...
				// Paginated archives
				echo '<li class="current item-current-' . get_query_var('paged') . '">' . __('Page', 'wpbootstrap' ) . ' ' . get_query_var('paged') . '</li>';
