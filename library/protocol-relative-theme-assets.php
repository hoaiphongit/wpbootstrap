...
if ( ! class_exists( 'wpbootstrap_Protocol_Relative_Theme_Assets' ) ) :
	class wpbootstrap_Protocol_Relative_Theme_Assets {
		/**
	...
	$wpbootstrap_protocol_relative_theme_assets = new wpbootstrap_Protocol_Relative_Theme_Assets;
endif;
